...
\section{Risk Analysis}
	...
	\chapter{Prototyping}
		...
		\section{Application}
			...
			In order to develop the model that controlled the document object model, I looked into using a JavaScript framework Backbone.js, to 
			
			\subsection{User Interface}
				\subsubsection{Flow}
				\subsubsection{Design}
				 I wanted to keep the design and structure of the web application simple and clean in order to minimise time and effort spent on it and to emphasise the sole purpose of the project. From the below figure, the multiple colour schemes that it went to after the prototype was finished can be seen. I settled on a design that I felt did not distract from the purpose of the web application but I also felt was modern and professional enough as to not deter people. 
							\begin{figure}[H]
								\caption{Iterations of Colour Scheme}
								\centering
								\includegraphics[scale=0.2]{colours.png}
							\end{figure}
	\chapter{Outcomes}
		\section{Data}
		\section{Discussion}
